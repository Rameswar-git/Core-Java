...
class FirstWorkerExc implements Runnable {

	private int counter;
	private Exchanger<Integer> exchanger;

	public FirstWorkerExc(Exchanger<Integer> exchanger) {
...
class SecondWorkerExc implements Runnable {

	private int counter;
	private Exchanger<Integer> exchanger;

	public SecondWorkerExc(Exchanger<Integer> exchanger) {
		this.exchanger = exchanger;
	}
...
class App {
	...
	public static void main(String[] args) {
		...
		new Thread(new FirstWorkerExc(exchanger)).start();
		new Thread(new SecondWorkerExc(exchanger)).start();
